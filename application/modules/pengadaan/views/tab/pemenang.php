			...
			<table>
				<tr class="input-form">
					...
					<td><?php 
						...
						if(count($res)>0){
							echo form_dropdown('pemenang', $res, $this->form->get_temp_data('pemenang'),'');
						}else{
							echo '-- Anda Belum Memilih Peserta --';
						}?>
				...
				<tr class="input-form">
					...
					<td>
						 Rp.<input type="text" name="idr_value" class="money-masked" value="<?php echo $this->form->get_temp_data('idr_value')?>">
					</td>
				</tr>
				<tr class="input-form">
					<td>
					...
					<td>
						...
						<input type="text" name="kurs_value" value="<?php echo $this->form->get_temp_data('kurs_value')?>" class="money-masked" >
				...
				<tr class="input-form">
					...
					<td>
						<input type="text" name="nilai_evaluasi" value="<?php echo $this->form->get_temp_data('kurs_value')?>">
