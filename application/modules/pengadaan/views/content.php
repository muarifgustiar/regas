	...
	<table class="tableData">
		<thead>
			<tr>
				...
				<td><a href="?<?php echo $this->utility->generateLink('sort','desc')?>&sort=<?php echo ($sort['proc_date'] == 'asc') ? 'desc' : 'asc'; ?>&by=proc_date">Log Pengadaan<i class="fa fa-sort-<?php echo ($sort['proc_date'] == 'asc') ? 'desc' : 'asc'; ?>"></i></a></td>
				<td><a href="?<?php echo $this->utility->generateLink('sort','desc')?>&sort=<?php echo ($sort['contract_date'] == 'asc') ? 'desc' : 'asc'; ?>&by=contract_date">Log Kontrak<i class="fa fa-sort-<?php echo ($sort['contract_date'] == 'asc') ? 'desc' : 'asc'; ?>"></i></a></td>
		...
		if(count($pengadaan_list)){
			...
			?>
				<tr>
					...
					<td><?php echo $value['proc_date'];?></td>
					<td><?php echo $value['contract_date'];?></td>
					<td class="actionBlock">
						<a href="<?php echo site_url('pengadaan/view/'.$value['id'])?>" class="editBtn"><i class="fa fa-search"></i>&nbsp;View</a>
					</td>
				</tr>
			<?php 
			}
