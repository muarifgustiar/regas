			...
			<form method="POST" enctype="multipart/form-data">
				<table>
					<tr class="input-form">
						...
						<td>
							<?php echo form_dropdown('id_vendor', $vendor_list, $this->form->get_temp_data('id_vendor'),'');?>
					...
					<tr class="input-form">
						...
						<td>
							<div style="margin-bottom: 10px">Dalam Rupiah : <input type="text" class="money-masked" name="contract_price" value="<?php echo $this->form->get_temp_data('contract_price');?>" maxlength="20"></div>
							<?php echo form_error('contract_price'); ?>
							<div style="margin-bottom: 10px">Dalam Mata Uang Asing : <?php echo $this->form->get_kurs(array('name'=>'contract_kurs'),$this->form->get_temp_data('contract_kurs'))?><input type="text" name="contract_price_kurs" value="<?php echo $this->form->get_temp_data('contract_price_kurs');?>" class="col-14 money-masked" maxlength="20"></div>
