	...
	<form method="POST" enctype="multipart/form-data">
		<table>
			...
			<tr class="input-form">
				...
				<td>
					<input type="text" name="percentage" value="<?php echo ($this->form->get_temp_data('percentage'))?$this->form->get_temp_data('percentage'):$percentage;?>" class="col-14"><span>%</span>
