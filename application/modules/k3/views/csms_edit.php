	...
	<form method="POST" enctype="multipart/form-data">
		<table>
			...
			<tr class="input-form lampiran_csms">
				...
				<td>
					<p><a href="<?php echo base_url('lampiran/csms_file/'.$csms_file)?>" target="_blank">Lampiran</a></p>
					<p><b><i style="color: #D62E2E;">Tinggalkan kosong jika tidak diganti</i></b></p>
					<input type="file" name="csms_file" value="<?php echo ($this->form->get_temp_data('csms_file'))?$this->form->get_temp_data('csms_file'):$csms_file;?>">
